...
class _CreatePackageViewState extends CreatePackageViewModel {
  ...
  Widget packageDetails(Size size ){
    return Column(crossAxisAlignment: CrossAxisAlignment.start,
      children: [
      Text(
  ...
  /// widget choose Country city date
  Widget countryCityDate(Size size){
    return Column(crossAxisAlignment: CrossAxisAlignment.start,
      children: [
      Text(
        tr("SelectCountries"),
  ...
  /// widget multiple choices
  Widget multipleChoices(Size size){
    return Column(crossAxisAlignment: CrossAxisAlignment.start,
      children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
  ...
  Widget buildBottomActionButton(Size size){
